        ...
        <section className="site-services">
          ...
          <div className="row">
            <div className="columns" data-aos="fade-up" data-aos-delay="200">
              ...
              <p className="numero"><span>₹</span>2,999</p>
              <ul className="ul-cards-services">
                ...
                <li>
                  ...
                  <span>
                    <FormattedMessage
                      id='services-info-1-p4'
                      defaultMessage='Basic Report and Setup Guide'
                    />
                  </span>
                </li>
                <li>
            ...
            <div className="columns recomendado" data-aos="fade-up" data-aos-delay="300">
              ...
              <p className="numero"><span>₹</span>7,999</p>
              <ul className="ul-cards-services">
                <li>
                  <i className="fas fa-check"></i>
                  <span>
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
              ...
              <p className="numero"><span>₹</span>14,999</p>
              <ul className="ul-cards-services">
                <li>
                  <i className="fas fa-check"></i>
                  <span>
                ...
                <li>
                  ...
                  <span>
                    <FormattedMessage
                      id='services-info-3-p3'
                      defaultMessage='Advanced API Integration'
                    />
                  </span>
                </li>
                <li>
